...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_TriggerSet p_TriggerSet;
        ...
        public static SteamVR_Input_ActionSet_TriggerSet TriggerSet
        {
            get
            {
                return SteamVR_Actions.p_TriggerSet.GetCopy<SteamVR_Input_ActionSet_TriggerSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_TriggerSet = ((SteamVR_Input_ActionSet_TriggerSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_TriggerSet>("/actions/TriggerSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.TriggerSet};
        }
    }
}
